...
const MainLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-50 flex flex-col items-center justify-start pt-8 px-4">
      {/* Header */}
      <header className="w-full bg-blue-700 text-white py-4 px-6 flex justify-between items-center mb-8">
      ...
      <main className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-700 mb-2">SPECTROPY — Learning Management System</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {roles.map((role) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-blue-700 mb-2">{role.label}</h3>
