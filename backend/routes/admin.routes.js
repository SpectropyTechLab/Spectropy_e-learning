...
import { upload, uploadContentFile, getSignedContentUrl, viewScormFile } from '../controllers/scorm.controller.js';
...
router.get("/content/signed-url", getSignedContentUrl);
